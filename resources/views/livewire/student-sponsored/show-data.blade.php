<div class="bg-blue-100 p-6">
    <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="w-80">
                    ...
                    <input wire:model="editing_student_address" value="{{$student_data->address}}" type="text" class=" text-gray-900 text-sm rounded block w-full border p-2.5">
                    @error('editing_student_register_name')
                        <span class="text-red-500 text-xs block">{{$message}}</span>
                    @enderror
                </div>
        ...
        <div class="flex justify-center mt-4">
            <a href="{{route('admin.studentSponsoredPhotos',$student_data->id)}}" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                ดูรูปภาพของนักเรียน
            </a>
